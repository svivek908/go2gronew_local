...
load_css(array('public/assets/stylesheet/pgstyle/terms-condition.css?')); ?>
   ...
   <div class="row">
      ...
      <div class="col-md-12">
         ...
         <p class="terms-font"> <strong>Regarding Your Registration</strong></p>
      ...
      <div class="col-md-12">
         ...
         <ul>
            <li>
               <p> Decompile, reverse engineer, disassemble, attempt to derive the source code of, or decrypt the application</p>
            </li>
            <li>
               <p> make any modification, adaptation, improvement, enhancement, translation or derivative work from the application</p>
            </li>
            <li>
               <p> violate any applicable laws, rules or regulations in connection with your access or use of the application</p>
            </li>
            <li>
               <p> remove, alter or obscure any proprietary notice (including any notice of copyright or trademark) of Company or its affiliates, partners, suppliers or the licensors of the application</p>
            </li>
            <li>
               <p> use the application for any revenue generating endeavor, commercial enterprise, or other purpose for which it is not designed or intended</p>
            </li>
            <li>
               <p> make the application available over a network or other environment permitting access or use by multiple devices or users at the same time</p>
            </li>
            <li>
               <p> use the application for creating a product, service or software that is, directly or indirectly, competitive with or in any way a substitute for the application</p>
            </li>
            <li>
               <p> use the application to send automated queries to any website or to send any unsolicited commercial e-mail</p>
            </li>
            <li>
               <p> use any proprietary information or interfaces of Company or other intellectual property of Company in the design, development, manufacture, licensing or distribution of any applications, accessories or devices for use with the application.</p>
            </li>
         </ul>
      </div>
      <div class="col-md-12">
         ...
         <ul>
            <li>
               <p>  <span> SCOPE OF LICENSE:</span> The license granted to you for the Company application is limited to a non-transferable license to use the Company application on a device that utilizes the Apple iOS or Android operating system, as applicable, and in accordance with the usage rules set forth in the applicable App Distributor terms of service.</p>
            </li>
            <li>
               <p>  <span> MAINTENANCE AND SUPPORT:</span> Company is solely responsible for providing any maintenance and support services with respect to the Company application, as specified in this Agreement, or as required under applicable law. You acknowledge that each App Distributor has no obligation whatsoever to furnish any maintenance and support services with respect to the Company application.</p>
            </li>
            <li>
      ...
      <div class="col-md-12">
         ...
         <ul>
            <li>
               <p> attempting to bypass any measures of the Website designed to prevent or restrict access to the Website, or any portion of the Website</p>
            </li>
            <li>
               <p> attempting to impersonate another user or person or using the username of another user</p>
            </li>
            <li>
               <p> criminal or tortious activity</p>
            </li>
            <li>
               <p>deciphering, decompiling, disassembling or reverse engineering any of the software comprising or in any way making up a part of the Website</p>
            </li>
            <li>
               <p>deleting the copyright or other proprietary rights notice from any Website content</p>
            </li>
            <li>
               <p>engaging in any automated use of the system, such as using any data mining, robots or similar data gathering and extraction tools</p>
            </li>
            <li>
               <p>except as may be the result of standard search engine or Internet browser usage, using or launching, developing or distributing any automated system, including, without limitation, any spider, robot (or "bot"), cheat utility, scraper or offline reader that accesses the Website, or using or launching any unauthorized script or other software</p>
            </li>
            <li>
               <p>harassing, annoying, intimidating or threatening any Company employees or agents engaged in providing any portion of the Company Services to you</p>
            </li>
            <li>
               <p>interfering with, disrupting, or creating an undue burden on the Website or the networks or services connected to the Website</p>
            </li>
            <li>
               <p>making any unauthorized use of the Company Services, including collecting usernames and/or email addresses of users by electronic or other means for the purpose of sending unsolicited email, or creating user accounts by automated means or under false pretenses</p>
            </li>
            <li>
               <p>selling or otherwise transferring your profile</p>
            </li>
            <li>
               <p>systematic retrieval of data or other content from the Website to create or compile, directly or indirectly, a collection, compilation, database or directory without written permission from Company</p>
            </li>
            <li>
               <p>tricking, defrauding or misleading Company and other users, especially in any attempt to learn sensitive account information such as passwords</p>
            </li>
            <li>
               <p>using any information obtained from the Website in order to harass, abuse, or harm another person</p>
            </li>
            <li>
               <p>using the Company Services as part of any effort to compete with Company or to provide services as a service bureau</p>
            </li>
            <li>
               <p>using the Website in a manner inconsistent with any and all applicable laws and regulations</p>
            </li>
         </ul>
      </div>
      <div class="col-md-12">
         ...
         <ul>
            <li>
               <p> monitor the Website for violations of this Agreement;</p>
            </li>
            <li>
               <p> take appropriate legal action against anyone who, in Company's sole discretion, violates this Agreement, including without limitation, reporting such user to law enforcement authorities;</p>
            </li>
            <li>
               <p> in Company's sole discretion and without limitation, refuse, restrict access to or availability of, or disable (to the extent technologically feasible) any user's contribution or any portion thereof that may violate this Agreement or any Company policy;</p>
            </li>
            <li>
               <p>in Company's sole discretion and without limitation, notice or liability to remove from the Website or otherwise disable all files and content that are excessive in size or are in any way burdensome to Company's systems;</p>
            </li>
            <li>
               <p>otherwise manage the Website in a manner designed to protect the rights and property of Company and others and to facilitate the proper functioning of the Website.</p>
            </li>
         </ul>
      ...
      <div class="col-md-12">
         ...
         <p>SNPC GLOBAL LLC<br>
            ...
            Phone: +1 (833) 346-2476 / +1 (833) 3GO-2GRO 
         </p>
      </div>
      <div class="col-sm-6 sm-6mrbt">
         ...
         <ul>
            ...
            <li>
               <p><strong>Social Media Website or Application - </strong>Facebook, Instagram, Twitter, Snapchat</p>
            </li>
            <li>
               <p><strong>Search Engine - </strong>Google, Yahoo, Bing</p>
            </li>
            <li>
               <p><strong>Website or Application Providing a Service or Product - </strong>YouTube, Apple, Uber</p>
            </li>
            <li>
               <p><strong>Gaming Website or Application - </strong>Playstation, Pokemon Go, Candy Crush</p>
            </li>
         </ul>
      </div>
      <div class="col-sm-6">
