       ...
       if(pro_code !=''){
               ...
               success: function (res) {
                   ...
                   if(res.error==true){
                       ...
                       <td   class="a-right"><span class="price" id="total_amount">$' + totalAmount + '</span></td>\
                       </tr>\
                       <tr>\
                       ...
                       <td   class="a-right"><span class="price1" id="coupencode">&nbsp;&nbsp;$' + deleviry_charge.toFixed(2) + '</span></td>\
                       </tr>';
