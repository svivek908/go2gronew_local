    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="contentEditable">
                ...
                <h2>Users of the Website Generally</h2>
        ...
        <div class="col-md-12">
            <div class="">
                ...
                <h2 class="sub-heading">Analytics</h2>
                <p>We may use third-party vendors, including Google, who use first-party cookies (such as the Google Analytics cookie) and third-party cookies (such as the DoubleClick cookie) together to inform, optimize and serve ads based on your past activity on the Website, including Google Analytics for Display Advertising. The information collected may be used to, among other things, analyze and track data, determine the popularity of certain content and better understand online activity. If you do not want any information to be collected and used by Google Analytics, you can install an opt-out in your web browser (https://tools.google.com/dlpage/gaoptout/) and/or opt out from Google Analytics for Display Advertising or the Google Display Network by using Google's Ads Settings <a href="#">(www.google.com/settings/ads)</a>. </p>
                <h2 class="sub-heading">Aggregated and Non-Personally-Identifying Information</h2>
                <p>We may share aggregated and Non-Personally Identifying Information we collect under any of the above circumstances. We may also share it with third parties and our affiliate companies to develop and deliver targeted advertising on the Website and on websites of third parties. We may combine Non-Personally Identifying Information we collect with additional Non-Personally Identifying Information collected from other sources. We also may share aggregated information with third parties, including advisors, advertisers and investors, for the purpose of conducting general business analysis. For example, we may tell our advertisers the number of visitors to the Website and the most popular features or services accessed. This information does not contain any Personally-Identifying Information and may be used to develop website content and services that we hope you and other users will find of interest and to target content and advertising. </p>
                <h2 class="sub-heading">Mobile Device Additional Terms</h2>
                <div class="col-md-12">
                    <ul>
                        <li>
                            <p><b>Mobile Device.</b> If you use a mobile device to access the Website or download any of our applications, we may collect device information (such as your mobile device ID, model and manufacturer), operating system, version information and IP address.</p>
                        </li>
                        <li>
                            <p><b>Geo-Location Information.</b>Unless we have received your prior consent, we do not access or track any location-based information from your mobile device at any time while downloading or using our mobile application or our services, except that it may be possible for Company to determine from an IP address the geographic location of your point of connectivity, in which case we may gather and use such general location data.</p>
                        </li>
                        <li>
                            <p><b>Push Notifications.</b> We send you push notifications if you choose to receive them, letting you know when someone has sent you a message or for other service-related matters. If you wish to opt-out from receiving these types of communications, you may turn them off in your device's settings.</p>
                        </li>
                        <li>
                            <p><b>Mobile Analytics.</b>We use mobile analytics software to allow us to better understand the functionality of our mobile software on your phone. This software may record information, such as how often you use the application, the events that occur within the application, aggregated usage, performance data and where the application was downloaded from. We do not link the information we store within the analytics software to any Personally-Identifying Information you submit within the mobile application.</p>
                        </li>
                    </ul>
                </div>
                <h2 class="sub-heading">SOCIAL MEDIA</h2>
                <p>We may provide you the option to connect your account on the Website to your account on some social networking sites for the purpose of logging in, uploading information or enabling certain features on the Website. When logging in using your social network credentials, we may collect the Personally-Identifying Information you have made publicly available on the social networking site, such as your name, profile picture, cover photo, username, gender, friends network, age range, locale, friend list and any other information you have made public. Once connected, other users may also be able to see information about your social network, such as the size of your network and your friends, including common friends. By connecting your account on the Website to your account on any social networking site, you hereby consent to the continuous release of information about you to us. We will not send any of your account information to the connected social networking site without first disclosing that to you. Each social network may further allow you to set privacy controls around your information on their system, and our collection of information will always follow such controls and permissions. This feature is subject to continuous change and improvement by us and each social networking site involved, and therefore the available features and shared information are subject to change without notice to you.</p>
                <p>We may use hyperlinks on the Website which will redirect you to a social network if you click on the respective link. However, when you click on a social plug-in, such as Facebook's "Like" button, Twitter's "tweet" button or the Google+, that particular social network's plugin will be activated and your browser will directly connect to that provider's servers. If you do not use these buttons, none of your data will be sent to the respective social network's plugin provider. So for example, when you click on the Facebook's "Like" button on the Website, Facebook will receive your IP address, the browser version and screen resolution, and the operating system of the device you have used to access the Website. Settings regarding privacy protection can be found on the websites of these social networks and are not within our control.</p>
                <h2 class="privacy-alltitel">COLLECTION, USE AND DISCLOSURE OF PERSONALLY-IDENTIFYING INFORMATION</h2>
                <h2 class="sub-heading">Website Registration</h2>
                <p>As defined above, Personally-Identifying Information is information that can be directly associated with a specific person. Company may collect a range of Personally-Identifying Information from and about Website users. Much of the Personally-Identifying Information collected by Company about users is information provided by users themselves when (1) registering for our service, (2) logging in with social network credentials, (3) participating in polls, contests, surveys or other features of our service, or responding to offers or advertisements, (4) communicating with us, (5) creating a public profile or (6) signing up to receive newsletters. That information may include each user's name, address, email address and telephone number, and, if you transact business with us, financial information such as your payment method (valid credit card number, type, expiration date or other financial information). We also may request information about your interests and activities, your gender, age, date of birth, username, hometown and other demographic or relevant information as determined by Company from time to time. Users of the Website are under no obligation to provide Company with Personally-Identifying Information of any kind, with the caveat that a user's refusal to do so may prevent the user from using certain Website features.</p>
                <h2 class="privacy-alltitel">BY REGISTERING WITH OR USING THE WEBSITE, YOU CONSENT TO THE USE AND DISCLOSURE OF YOUR PERSONALLY-IDENTIFYING INFORMATION AS DESCRIBED IN THIS "COLLECTION, USE AND DISCLOSURE OF PERSONALLY-IDENTIFYING INFORMATION" SECTION.</h2>
                <h2 class="sub-heading">Online Postings</h2>
                <p>Certain Personally-Identifying Information collected from users may be disclosed as a matter of course as a result of your use of the Website. We may provide areas on the Website where you can post reviews and other information relating to your activities on the Website. Such postings are governed by our Terms of Use. In addition, such postings may appear on other websites or when searches are executed on the subject of your posting. Also, whenever you voluntarily disclose personal information on publicly-viewable web pages, that information will be publicly available and can be collected and used by others. For example, if you post your email address, you may receive unsolicited messages. We cannot control who reads your posting or what other users may do with the information you voluntarily post, so we encourage you to exercise discretion and caution with respect to your personal information. USERS ASSUME ALL RESPONSIBILITY FOR ANY LOSS OF PRIVACY OR OTHER HARM RESULTING FROM THEIR VOLUNTARY DISCLOSURE OF PERSONALLY IDENTIFYING INFORMATION.

                </p>

                <h2 class="sub-heading">Company Communications</h2>
                ...
                <h2 class="prcvacy-textalingleft privacy-textmr">PRIVACY POLICY CHANGES</h2>
                ...
                <h2 class="prcvacy-textalingleft">CHILDREN</h2>
                ...
                <h2 class="prcvacy-textalingleft">CALIFORNIA PRIVACY RIGHTS</h2>
                <p>California Civil Code Section 1798.83, also known as the "Shine The Light" law, permits our users who are California residents to request and obtain from us, once a year and free of charge, information about the Personally-Identifying Information (if any) we disclosed to third parties for direct marketing purposes in the preceding calendar year. If applicable, this information would include a list of the categories of the Personally-Identifying Information that was shared and the names and addresses of all third parties with which we shared Personally-Identifying Information in the immediately preceding calendar year. If you are a California resident and would like to make such a request, please submit your request in writing to our privacy officer as listed below. </p>
                <h2 class="prcvacy-textalingleft">DO-NOT-TRACK POLICY</h2>
                ...
                <h2 class="prcvacy-textalingleft">CONTACT</h2>
                <p>If you have any questions regarding our Privacy Policy, please contact our Privacy Officer at:</p>
                <p>SNPC Global LLC
                    <br /> Attn: Privacy Officer
                    <br /> 5005 Cameron Forest PKWY
                    <br /> Johns Creek, GA 30022
                    <br /> Email: sid@woolways.com
                    <br /> Phone: (717) 350-0854
                    <br />
                </p>
        ...
        <div>
            <div class="contentEditableContainer contentTextEditable">
                <div class="col-md-6">
                    <h2><b>GENERAL INSTRUCTION</b><br /><br />WHAT IS A PRIVACY POLICY? <br /></h2>
                    <p>A Privacy Policy is a document or statement that describes how a company gathers, uses, manages, and releases the information of customers or visitors to its website. By accessing the company's website, users accept to have to having their information collected and disclosed in accordance with the company's Privacy Policy.</p>
                    <h2>WHAT SHOULD BE INCLUDED?</h2>
                    <p>A simple Privacy Policy will identify the following basic elements:</p>
                    <div class="col-md-12">
                        <ul>
                            <li>
                                <p><b>Company:</b>The name of the company that owns the website collecting information from its users. </p>
                            </li>
                            <li>
                                <p><b>Website:</b>The URL address of the company's website that the user will be browsing and accessing.</p>
                            </li>
                            <li>
                                <p><b>User's Information:</b>A description of the type of information that the website collects and discloses. </p>
                            </li>
                            <li>
                                <p><b>Collection, Use, and Disclosure:</b>What information the company will collect , how they will collect and use the information, and when and to whom they will disclose the information. </p>
                            </li>
                        </ul>

                    </div>
                    <h2><b>WHEN IS IT NEEDED?</b></h2>
                    <p>While there is no federal law in the United States requiring that websites establish a Privacy Policy, many states and most other countries do require a website that collects and stores any personal information from its users to have one.</p>
                    <p>In the United States, the Federal Trade Commission (FTC) regulates laws and policies regarding the privacy practices of businesses and the protection of their customers' personal information. The FTC also helps to enforce federal laws concerning the privacy of customers' information, including the following:</p>
                    <div class="col-md-12">
                        <ul>
                            <li>
                                <p>Fair Credit Reporting Act (FCRA), which limits how companies can obtain and use a customer's credit and background reports.</p>
                            </li>
                            <li>
                                <p>Gramm-Leach-Bliley Act, which requires financial institutions to clearly explain their information sharing practices and also restricts the sharing and use of specific financial information.</p>
                            </li>
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <ul>
                            <li>
                                <p>Health Insurance Portability and Accountability Act (HIPAA) created a "Privacy Rule" that establishes a national set of standards of how health care service providers can use an individual's protected health information.
                                </p>
                                </li>
                            <li>
                                <p>Children's Online Privacy Protection Act (COPPA), requires websites that target and/or collect information from children under the age of 13 to post a Privacy Policy that complies with the COPPA requirements, and also implements certain parental notice and consent requirements.</p>
                            </li>

                        </ul>
                    </div>
                    <p>Even if your company or website is not in a jurisdiction that requires a privacy policy, the reach of your website may subject it to the laws of other states and countries. For example, California, has enacted the California Online Privacy Protection Act of 2003 (CALOPPA) which requires any website collecting personal information to have a Privacy Policy posted on its website that is easily accessible to its users. Even if your website is not run from California, CALOPPA applies to any website that collects personal information from a California resident. Therefore it is likely that your website will be subject to the CALOPPA regulations.</p>
                    <p>The European Union has more established laws regarding privacy protection, including the Data Protection Directive (95/46/EC) and the E-Privacy Directive (2002/58/EC). These directives state that personal information of European Union residents can only be transferred to countries outside of the European Union that have policies with an adequate level of protection.</p>
                    <p>Therefore, if you are a website that gathers, stores, or uses personal information and data from clients and users, you should have a Privacy Policy for your website. You also need to make sure that you adhere to the promises and disclosures set forth in that policy.</p>
                    <h2 class="privacy-text"><b>OTHER NAMES</b></h2>
                    <p>A Privacy Policy may also be called: Privacy Statement, Internet Privacy Policy, Website Privacy Policy, Privacy Notice, Privacy Page, Privacy Information Policy</p>
