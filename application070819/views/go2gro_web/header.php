   ...
   <div class="header-banner">
      <div class="assetBlock">
         ...
         <div class="height20 flowhidden" id="slideshow">
            ...
            <p class="d-none"><a href="#">Order timings:<span class="padleft5"> <?php if($this->session->has_userdata('select_store_data'))
               {
         ...
         <div class="modal-body">
            <div class="clearfix">
               <div class="col-md-12 invite_bg">
                  <img src="<?php echo base_url();?>images/refel_g2gro_logo.png"  />
                  <h3> Give $5 , Get $5</h3>
