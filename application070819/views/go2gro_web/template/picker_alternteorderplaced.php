		...
		<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
                                ...
                                <div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<h2><p class="welcomtxt ">Go2Gro Invoice ('.$orderid.')!</p></h2>
                                                    <p> <strong> Subject: Go2Gro Invoice ('.$orderid.') !</strong></p>
													 <p>Date:<strong>' . $datetime . '</strong></p><br>
                                                    <p>Dear ' . $fullname . ',</p>
<p>Your transaction id is <strong> #' . $txnid . '</strong></p>													<p>We are here to save your run to the grocery store, ensuring fresh groceries in your kitchen! Our dedicated team prepares your order as soon as you hit checkout, and bring it to your doorstep with a smile on our face.</p>
    ...
    if ($tip_amount != 0) {
        $sendmail .= '<p><strong>Your Tip Amount : $' . $tip_amount . '</strong></p>';
    }
    ...
    $sendmail .= ' </div>
                                                    ...
                                                    <table class="invoice-table fontfamily tab1" width="100%" >
                                                    	<tr class="heading">
                                                            ...
                                                            <tr>
                                                            	<td><strong class="mobl">Name :</strong><span class="mobr">' . $fullname . '</span></td>
                                                                <td><strong class="mobl">Contact Number :</strong><span class="mobr">' . $bi_contact . '</span></td>
                                                                <td><strong class="mobl">Email :</strong><span class="mobr">' . $bi_email . '</span></td>
                                                                <td><strong class="mobl">Address :</strong><span class="mobr">' . $bi_address . '</span></td>
                                                            </tr>
                                                    ...
                                                    <table class="invoice-table fontfamily tab1" width="100%" >
                                                    	<tr class="heading">
                                                            ...
                                                            <tr>
                                                            	<td><strong class="mobl">Order Id:</strong><span class="mobr">#' . $orderid . '</span></td>
                                                                <td><strong class="mobl">Sub Total:</strong><span class="mobr">$' . number_format((float)$subtotal, 2, '.', '') . '</span></td>
                                                                <td><strong class="mobl">Sales Tax:</strong><span class="mobr">$' . number_format((float)$totaltax, 2, '.', '') . '</span></td>
                                                            </tr>
                                                            <tr bgcolor="#e9f9ce" class="ondesk">
                                                            ...
                                                            <tr>
                                                                <td><strong class="mobl">Processing Fee:</strong><span class="mobr">$' . number_format((float)$processingfees, 2, '.', '') . '</span></td>
                                                                <td><strong class="mobl">Delivery Charge:</strong><span class="mobr">$' . number_format((float)$deliverycharge, 2, '.', '') . '</span></td>
                                                                <td><strong class="mobl">Grand Total:</strong><span class="mobr">$' . number_format((float)$finalprice, 2, '.', '') . '</span></td>
                                                            </tr>
                                                    ...
                                                    <table class="invoice-table fontfamily tab1" width="100%" >
															...
															';
    $result = $db->getcartitemformail($orderid,$store_id);
    if ($result->num_rows > 0) {

        while ($task = $result->fetch_assoc()) {
            $total = $task['price'] * $task['item_quty'];
            $totalround = number_format((float)$total, 2, '.', '');
            /* array_push($response["category"], $task);*/
            $sendmail .= '  <tr>
                                                            	<td><strong class="mobl">Product Name:</strong><span class="mobr">' . $task['item_name'] . '</span></td>
                                                                <td><strong class="mobl">Product Price :</strong><span class="mobr">$' . $task['price'] . '</span></td>
                                                                <td><strong class="mobl">Product QTY:</strong><span class="mobr">' . $task['item_quty'] . '</span></td>
                                                                <td><strong class="mobl">Total</strong><span class="mobr">$' . $totalround . '</span></td>
                                                            </tr>';
        }
