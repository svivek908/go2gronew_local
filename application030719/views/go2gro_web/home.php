...
?>
<div class="slideshow-container" style="top: 95px;">
    <div class="mySlides fade1 res-mar">
        <img src="<?php echo $banner_slider_img; ?>" style="width:100%">
    </div>
...
<style> 
  .them-bg{background-color: #f5f5f5!important;}
    .item-img{min-height: 130px;}
	...
	@media (max-width: 700px){
		...
		.pro-name{font-size:14px !important;}
	}
...
<section class="main-container col2-left-layout bounceInUp animated">
    ...
    <div class="container">
        <div class="row">
            <div class="col-main col-sm-12 product-grid" style="margin-top: 92px;">
                <div class="pro-coloumn them-bg">
                    <article class="col-main" style="margin-top: 30px;">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="row js-masonry" data-masonry='{ "itemSelector": ".grid-item", "columnWidth": ".grid-sizer","percentPosition": true,  "transitionDuration": "0.3s" }'>
                                                <div class="grid-sizer col-md-2 col-xs-6"></div>
                                                ...
                                                <div class="grid-item col-md-2 col-sm 4 col-xs-4">
                                                    <div class="media-grid" style="height: 200px;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="background:#fff;">
                ...
                <div class="media" id="cat_product_grid1" style="background:#fff;">
