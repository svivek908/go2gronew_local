...
?>
<footer>
    <?php load_css(array('public/assets/stylesheet/pgstyle/footerstyle.css?'));?>
<!-- Modal -->
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
		<button type="button" class="btn btn-default" style="background:#7fcb28;border:none;color:#fff;">OK</button>
        <button type="button" class="btn btn-default" style="background:#c00;border:none;color:#fff;" data-dismiss="modal">Close</button>
      </div>
    </div>
        ...
        <div class="container">
            <div class="row">
			  <div class="col-sm-4 col-xs-12 col-lg-4">
                    <div class="co-info">
					<div class="text-left">
                        <a href="https://www.go2gro.com/go2gro_beta/"><img src="<?php echo base_url('public/assets/images/logo_footer.png');?>" alt="footer logo">
                        </a>
                    </div>
                    <address>
                ...
                <div class="col-sm-6 col-xs-12 col-lg-5">
                    ...
                    <div class="footer-column" style="padding-left: 45px;">
                        <h4>Information</h4>
                        <ul class="links">
                    ...
                    <div class="col-sm-2 col-xs-12 col-lg-3">
                        <div style="padding-top:72px">
						  <h4>Download App</h4>
							...
							<div class="app">
                                <a target="_blank" href="https://play.google.com/store/apps/details?id=com.go2gro_user.go2gro">
                                    <img class="and_img" src="<?php echo base_url('public/assets/images/play-store.png');?>" alt="Android">
                                </a>
                                <a target="_blank" href="https://itunes.apple.com/us/app/go2gro/id1317699292?ls=1&mt=8">
                                    <img class="and_img" src="<?php echo base_url('public/assets/images/apple.png');?>" alt="Apple">
                                </a>
							</div>
    ...
    <!--footer-middle-->
    <div class="footer-bottom" style="padding: 5px 0px;background: #f9f9f9; border-top:1px solid #ededed;">
        <div class="container">
            <div class="row">
                 <div class="col-sm-4 col-xs-12 text-left coppyright"> <span style="padding-top: 11px;display:block;"> © 2018 SNPC Global, LLC All Rights Reserved. </span> </div>
                 <div class="col-sm-8 col-xs-12 text-right authorizefooter-img" style="margin-top: 5px;">
                     <div class="col-md-6">
                         <a href="javascript:void(0)" style="display: block;text-decoration: none;"> Payment Options:</a>
                     </div>
                     <!-- (c) 2005, 2018. Authorize.Net is a registered trademark of CyberSource Corporation -->
                     <div class="col-md-6">
                         <div class="AuthorizeNetSeal" style="display: inline;">
...
<script>
        ...
        if(api_key !='not defined' && api_key!=''){
            ...
            success: function (res) {
                ...
                if (res.error == true) {
                    ...
                    //html1 = html1;
                    html1 = '<div><img style="width: 71%;margin: 35% auto;display: block;" src="<?php echo base_url('public/assets/images/empty-cart.jpg'); ?>">' +
                    '<a class="btn-checkout" title="Continue Shopping" href="javascript:void()" style="bottom: 0px;position: absolute;right:0px;    color: #fff;" onclick= "closeNav()"><span style="font-size:20px;">Continue Shopping</span></a>'+
                    '</div>';
                    ...
                    if (api_key != 'not defined') {
                        ...
                        var jsonLength1;
                        /* // Removed condition of showing only 2 items in the cart pop-up
                        if (jsonLength >= 2) {
                            jsonLength1 = 2;
                        } else {
                        */
                        ...
                        */
                        ...
                        html1 +='<div class="subtotal-block"  style="  display:none;  position: absolute;width: 100%;bottom: 40px;background: #ededed;z-index: 99;">'+'<p> Sub-Total <span class="fright"> $'+parseFloat(totalAmount).toFixed(2)+' </span> </p>'+'</div>';
                        ...
                        for (var i = 0; i < jsonLength1; i++) {
                            ...
                            html1 += '<ul class="mini-products-list" id="cart-sidebar">\
                                ...
                                <div class="change-qunty" style="display:none;">\
                                <button onclick="minusqtyheader(\'' + result.item_id + '\');" class="reduced items-count" type="button" style="padding:5px;"><i class="icon-minus">&nbsp;</i></button>\
                                ...
                                <button onclick="plusqtyheader(\'' + result.item_id + '\');" class="increase items-count" type="button" style="padding:5px;"><i class="icon-plus">&nbsp;</i></button>\
                                </div>\
                                <div><span class="mycart_change_qnt"> ' + result.item_quty + ' <input type="hidden" data-id="qtyval_' +result.item_id + '" type="text" disabled  name="qtyheader" id="qtyheader_' + result.item_id + '" maxlength="12" value="' + result.item_quty + '" title="Quantity:" class="input-text input-text-01 qty"> </span> <span style="display:inline-block;width:35px;float:left;"> \
                                <button class="btn btn_down_arrow" onclick="plusqtyheader(\'' + result.item_id + '\');"><i class="icon-plus" style="color:#6b6b6b;"></i> </button> <button class="btn btn_down_arrow" onclick="minusqtyheader(\'' + result.item_id + '\');"><i class="icon-minus" style="color:#6b6b6b;"></i> </button></span> <div style="display: inline-block;text-align: right;width: 90px;">\
                                <div> <p style="font-size:16px;font-weight:normal;"> $'+parseFloat(result.total).toFixed(2)+'</p></div><div> <p style="font-size:14px;font-weight:normal;cursor: pointer;" onclick="delete_cart1(\'' + result.item_id + '\')"> <i class="icon-trash" style="color:#42b83f; margin-right:3px;"></i>Delete</p></div>\
                                </div> </div>\
                                </strong> <!-- <span class="price22323" style="color: red;">$' + parseFloat(result.item_price).toFixed(2) + '</span>-->\
                                </div>\
                                </div>\
                                </li>\
                                </ul>';
                        ...
                        html1 += '<div class=""><div class="">\
                            ...
                            <div class="actions">\
                            <a class="btn-checkout" title="Checkout" style="bottom: 0px;position: absolute;right: 0px;color: #fff;height: 50px;text-align: left;padding-left: 15px;" href="<?php echo base_url();?>ShoppingCart"><span style="text-align:left;margin-top: 10px;display: inline-block;"> Sub Total : $'+totalAmount+' </span><span style="font-size:18px;float:right;padding-right:15px;margin-top:10px;"> Checkout</span></a>\
                            </div>\
                           </div>';
                        ...
                        html1 += '<div class="fl-mini-cart-content" style="display: block;">\
            ...
            success: function (res) {
                ...
                for (var i = 0; i < jsonLength; i++) {
                    ...
                    html3 += '<div class="item">\
                            <div class="item-inner">\
                            <div class="item-img"  style="background: #dedede; width:190px;">\
                            <div class="item-label11 new-top-left11"></div>\
                            <div class="item-img-info">\
                            <a href="<?php echo base_url();?>productDetail?id=' + result.item_id + '" title="' + result.item_name + '" class="product-image"><img style="width:190px; height:190px;"  src="<?php echo $this->config->item('api_img_url');?>' + result.item_image + '" onerror="this.src=\'<?php echo $this->config->item('api_img_url');?>upload/item/noprivew.jpg\';"  alt="' + result.item_name + '"></a>\
                            </div>\
                            </div>\
                            <div class="item-info">\
                            ...
                            <div class="add_cart">\
                            <div class="change-qunty '+hiddenClassQty+'" data-id="qty_'+result.item_id+'" style="border: solid 1px #eee;border-radius: 50px;box-shadow: 2px 2px 2px #eee;">\
                            <button onClick="minusqtyheader(\'' + result.item_id + '\');" class="" type="button" style="    background: #fff;border: 0px;color: #96cb50;border-radius: 0px 50px 50px 0px;text-align: center;padding: 0;outline: whitesmoke;"><i class="icon-minus">&nbsp;</i></button>\
                            \
                            <span><input type="text" data-id="qtyval_'+result.item_id+'" disabled  name="result.item_id" id="qty_' + result.item_id + '" maxlength="12" value="'+qtyID+'" title="Quantity:" class="" style="background:#fff;border: none;width: 40px;color: #8cc63f;padding: 3px;margin-bottom: 0px;text-align: center;"></span>\
                            \
                            <button onClick="plusqtyheader(\'' + result.item_id + '\');" class="" type="button" style="    background: #fff;border: 0px;color: #96cb50;border-radius: 0px 50px 50px 0px;text-align: center;padding: 0;outline: whitesmoke;" ><i class="icon-plus">&nbsp;</i></button>\
                            \
                            </div>\
                            ...
                            <button style="display:none;" class="button btn-cart" disabled="disabled" id="cartchange" type="button" onclick=Addcartitemlist(\'' + result.item_id + '\',' + result.item_price + ',' + result.Sales_tax + ')><span>Adding</span></button>\
                            </div>\
                            </div>\
                            </div>\
                            </div>\
    ...
    function shoppingcartdata() {
        ...
        if (shoppingcartData.error == false) {
            ...
            for (var i = 0; i < jsonLength; i++) {
                ...
                html1 += '<tr class="odd">\
                      <td class="image hidden-table" style="width: 10%;">\
                      ...
                      <div class="change-qunty" style="text-align: center;">\
                      <button onclick="minusqtyheader(\'' + result.item_id + '\');" class="reduced items-count items-count-cart shoppingcard-min" type="button"><i class="icon-minus">&nbsp;</i></button>\
                      <span><input data-id="qtyval_'+result.item_id+'" style="margin-left: 2px;" type="text" disabled name="qty" id="cartupdateqty_' + result.item_id + '" maxlength="12" value="' + result.item_quty + '" title="Quantity:" class="card-count"></span>\
                      <button onclick="plusqtyheader(\'' + result.item_id + '\');" class="increase items-count items-count-cart  shoppingcard-plus" type="button"><i class="icon-plus">&nbsp;</i></button>\
                      </div>\
                      </td>\
            ...
            html3 += '<tr>\
                    ...
                    '+ discount_label +'</td>\
                    <td style="" class="a-right">\
                    <span class="priceq" id="" style="min-width: 120px;display: inline-block;">- $' + discount_amnt + '</span></strong>\
                    </td>\
                    </tr>\
            ...
            html1 += '<tr class="odd"><td style="width:100%;"><h2 class="product-name">' + shoppingcartData.message + '</h2></td><tr>';
        }
    ...
    function mycartdatarightsidebar() {
        ...
        if (myCartData.error == true) {
            ...
            <?php }else {?>
            html1 += '<div class="summary">\
                    <p class="amount" style="padding-top: 15px;padding-left: 15px;">Please Login to view your cart</p>\
              </div>';
            <?php } ?>
        } else {
            if (api_key != 'not defined') {
                ...
                html1 = '<div class="summary">\
                    <p class="amount">You Are Not Login User <a href="<?php echo base_url();?>login"><span style="color:green;">Please Login To View</span></a> your cart.</p>\
              </div>';
            }
        }
...
//        if( !isNaN( qty ))
    ...
    function contentdata(tips_arr) {
       ...
       // console.log(totaltax);
        ...
        html2 += '<tr>\
                        ...
                        Subtotal    </td>\
                        <td style="" class="a-right">\
                        <span class="price11" id="cartpriceval11">$' + price.toFixed(2) + '</span>  </td>\
                    </tr>\
                     <tr>\
                    <td style="" class="a-left" colspan="1">\
                        Sales  Tax  </td>\
                    <td style="" class="a-right">\
                        <span class="text" id="taxval" >$' + totaltax.toFixed(2) + '</span></td>\
                    </tr>\
                    <tr>\
                    <td style="" class="a-left" colspan="1">\
                        Processing Fee </td>\
                    ...
                    <td style="" class="a-right">\
                        <span class="price1" id="coupencode14">&nbsp;&nbsp;$' + deleviry_charge.toFixed(2) + '</span>    </td>\
                    </tr>\
                    <tr style="background:#f6f9f3;">'+new_tips_section+'</tr>';
                    /*
                    <tr>\
            <td style="" class="a-left" colspan="1">\
            Tip </td>\
        ...
        html3 += '<tr>\
                    ...
                    <td style="" class="a-right">\
                        <span class="price1" id="subtotalcartprice">&nbsp;&nbsp;$' + sub_total_Am0unt.toFixed(2) + '</span>    </td>\
                    </tr>\
                    <tr>\
                    <td style="" class="a-left" colspan="1">\
                        '+ discount_label +'  <!--<span class="pull-right">Promo: Stay Warm</span> -->  </td>\
                    <td style="" class="a-right">\
                        <span class="price1" id="discounamount">&nbsp;&nbsp;-$' + discount_amnt+ '</span>    </td>\
                    </tr>\
                    <tr>\
                        <td style="" class="a-left" colspan="1">\
                        <strong>Grand Total</strong>\
                    ...
                    <td style="" class="a-right">\
                        <strong><span class="price" id="finalcartprice">$' + total_Am0unt.toFixed(2) + '</span></strong>\
                    </td>\
                    </tr>';
    ...
    function set_tip(tips_arr){
        ...
        var default_tip = (price * tips_arr.default * 0.01).toFixed(2);
        ...
        var new_tips_section = '<td colspan="2">\
                                    <div> \
                                        <p style="display:inline-block;"> $ Select a tip amount </p>\
        ...
        for(var i=0; i<tips.length; i++) {
            ...
            new_tips_section += '           <div id="tip_'+tips[i]+'" class="tip_amt '+active+'" onclick="'+onclick_str+'" style="cursor:pointer;/*border-radius: 2px 0px 0px 2px;*/"> \
                                                <p> '+tips[i]+'% </p>\
                                                <p> $'+tip_amount+' </p> \
                                            </div>';
        }
        new_tips_section += '           </div> \
                                ...
                                // <button class="button btn custm_btn" data-toggle="modal" data-target="#myModal"> Custom</button>\

        // var tip_section = '$<span class="text" id="tipamount">'+default_tip+'</span>';
        /*
        for(var i=0; i<tips.length; i++){
            var tip_amount = (price * tips[i] * 0.01).toFixed(2);
            // console.log('Tip % - '+tips[i]+' Amount - '+tip_amount);
            var onclick_str = "add_tip_to_gtotal("+tip_amount+")";
            tip_section += '<div style="background-color:grey;width:50px;height: 50px;margin:5px;" onclick="'+onclick_str+'">';
            tip_section += tips[i]+'%<br>'+tip_amount;
            tip_section += '</div>';
        }
        */
        // tip_section += '<div style="background-color:grey;width:50px;height: 50px;margin:5px" onclick="input_custom_tip()">Custom</div>';
    ...
    function add_tip_to_gtotal(tip, tip_percent){
        ...
        var discount_amnt = localStorage.getItem("discount_amnt");
        var discount_amnt = parseFloat(discount_amnt).toFixed(2);
        ...
        authorizeAmount = calculateAuthorizeAmt(total_Am0unt.toFixed(2));
        jQuery('#subtotalcartprice').text("$" + total_w_tip.toFixed(2));
        jQuery('#discounamount').text("-$" + discount_amnt);
        jQuery('#finalcartprice').text("$" + total_Am0unt.toFixed(2));
        jQuery('#authAmount').text("$" + authorizeAmount);
        var tip_str = '';
        if(tip_percent == 'na'){
    ...
    function formatedDate(date1) {
        var timeZone = '<?php echo $this->config->item('time_zone'); ?>';
        //return moment(date1).tz(timeZone).format("DD-MM-YYYY");
    ...
    function getCardImage(Type) {
        if (Type == 'Discover')
            return "<?php echo base_url().'images/discover.png'; ?>";
        else if (Type == 'Visa')
            return "<?php echo base_url().'images/payment-2.png'; ?>";
        else if (Type == 'AmericanExpress')
            return "<?php echo base_url().'images/payment-3.png'; ?>";
        else if (Type == 'MasterCard')
            return "<?php echo base_url().'images/payment-4.png'; ?>";
        else if (Type == 'DinersClub')
            return "<?php echo base_url().'images/dinnerclub.png'; ?>";
        else if (Type == 'JCB')
            return "<?php echo base_url().'images/jcb.png'; ?>";
        else
            return "<?php echo base_url().'images/default_card.png'; ?>";
    }
    ...
    function ajaxindicatorstart(text)
    {
        ...
        jQuery('body').append('<div id="resultLoading" style="display:none"><div><img src="<?php echo base_url('public/assets/images/ajax-loader.gif');?>"><div>'+text+'</div></div><div class="bg"></div></div>');
        }
