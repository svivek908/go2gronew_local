...
<div class="main-container col2-right-layout" style="margin-top:165px;">
    <div class="main container">
        <div class="row">
            <section class="col-main col-sm-12 wow bounceInUp animated animated cart-collaterals" style="visibility: visible; ">
                <div id="messages_product_view"></div>
                <div class="totals" id="membership_plan_htmldata">
                    <h3>Select your membership plan</h3>
                    <div class="inner clearfix">
                    
                       <!--<div class="col-md-12 membership_block"> 
                            <label style="width:100%;"> 
                                <div class="row"> 
                                    <div class="col-md-12"> 
                                        <div>
                                            <input id="radio-1" class="radio-custom" name="radio-group" type="radio" checked>
                                            <label for="radio-1" class="radio-custom-label col-md-12" >
                                                <div class=""> 
                                                    <div class="col-md-8 col-sm-8 col-xs-12 mem_detail clearfix">
                                                        <h4 style="color:#7fcb28;"> $10 Per Month </h4>
                                                        <p> There are many variations of passages of Lorem 
                                                            Ipsum available, but the majority have suffered 
                                                            alteration in humour</p>
                                                    </div>
                                                    <div class="col-md-3 col-sm-3 col-sm-12 text-right mem_amnt ">
                                                        <h4 style="color:#7fcb28;"> $ 150.30 </h4>
                                                        <p> For 1 MONTH</p>
                                                    </div>
                                                </div>
                                            </label>
                        ...
                        <div class="col-md-12 membership_block membership_active "> 
                            <label style="width:100%;"> 
                                <div class="row"> 


                                    <div class="col-md-12 active_planinfo"> 
                                        <div> <p> There are many variations of passages of Lorem Ipsum available</p> </div>
                                    </div>
                                    ...
                                    <div class="col-md-12"> 
                                        <div>
                                            ...
                                            <label for="radio-2" class="radio-custom-label col-md-12" >
                                                <div class=""> 
                                                    <div class="col-md-8 col-sm-8 col-xs-12 mem_detail clearfix">
                                                        <h4 style="color:#7fcb28;"> $10 Per Month </h4>
                                                        <p> There are many variations of passages of Lorem 
            ...
            <!--col-right sidebar-->
      <div class="col-sm-12" style="margin: 30px auto;padding: 0px;"> 
      <section class="col-main col-sm-12 cart-collaterals" style="visibility: visible; " id="creditcardpanel"> 
        <div class="totals" style="margin-bottom:15px; ">
                    <div>
                        <h3>Credit Card Detail <button type="button" class="pull-right btn btn-primary creditbtn" id="creditbtn" data-toggle="modal" data-target="#creditcard" onclick="resetFormProfile();" style="width:180px;margin-top: -10px;font-size: 12px;">  Add Card</button></h3>
                    </div>
                    ...
                    <div class="modal-body clearfix checkout-card">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-sm-12 controls">
                                ...
                                <input type="text" name="zipcode" id="zipcode" placeholder="Zip Code" class="zipcode-container" style="width:100px;display: inline-block; margin-right:5px;">
                                <p class="marT15"style="display: inline-block;" id="addressvali"></p>
                            </div>
                        ...
                        //jQuery('#cardViewProfile .deliveryloader').remove();
                            ...
                            if(res.status=="Valid"){
                                ...
                                for(var i=0; i<membership_plan.length; i++){
                                    ...
                                    if(membership_plan[i].id == res.planid){
                                        ...
                                        select_html+='<div class="col-md-12 membership_block membership_active">\
                                            <label style="width:100%;"><div class="row"><div class="col-md-12 active_planinfo"><div> <p> '+ res.message +'</p> </div></div>\
                                            <div class="col-md-12"><div><input id="radio-'+membership_plan[i].id +'" class="radio-custom" name="radio-group" type="radio" '+ check +' value='+membership_plan[i].id+'  disabled><label for="radio-'+membership_plan[i].id +'" class="radio-custom-label col-md-12" ><div class=""><div class="col-md-8 col-sm-8 col-xs-12 mem_detail clearfix"><h4 style="color:#7fcb28;">'+membership_plan[i].plan_name+'</h4><p>'+ membership_plan[i].description +'</p>\
                                        </div><div class="col-md-3 col-sm-3 col-sm-12 text-right mem_amnt "><h4 style="color:#7fcb28;"> $'+membership_plan[i].price+' </h4>\
                                        </div></div>\
                                        </label></div> \
                                                </div>\
                                            </div>\
                                         ...
                                         unselect_html+='<div class="col-md-12 membership_block">\
                                            <label style="width:100%;"><div class="row"><div class="col-md-12"><div><input id="radio-'+membership_plan[i].id +'" class="radio-custom" name="radio-group" type="radio" value='+membership_plan[i].id+'  disabled><label for="radio-'+membership_plan[i].id +'" class="radio-custom-label col-md-12" ><div class=""><div class="col-md-8 col-sm-8 col-xs-12 mem_detail clearfix"><h4 style="color:#7fcb28;">'+membership_plan[i].plan_name+'</h4><p>'+ membership_plan[i].description +'</p>\
                                        </div><div class="col-md-3 col-sm-3 col-sm-12 text-right mem_amnt "><h4 style="color:#7fcb28;"> $'+membership_plan[i].price+' </h4>\
                                        </div></div>\
                                        </label></div> \
                                                </div>\
                                ...
                                for(var i=0; i<membership_plan.length; i++){
                                    ...
                                    <label style="width:100%;"><div class="row">\
                    ...
                    if(res.error==true){
                        ...
                        if(res.type == "0"){
                            ...
                            for(var i=0; i<cardDetail.length; i++){
                                ...
                                cardhtml += '<div class="col-xs-12 col-md-6 " id="card_id_'+paymentProfilesID+'"><div class="visapayment" >\
