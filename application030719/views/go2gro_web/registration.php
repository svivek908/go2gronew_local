...
<body class="zipcode_bg">
    ...
    <div class="container"> 
        <div class="col-md-5 col-md-offset-7"> 
            <div class="login-container clearfix" style="padding-bottom: 20px !important;margin-top:15%; "> 
                 <div class="col-md-12 text-center">
                    <a href="<?php echo base_url();?>" title="Go2Gro">
                        <div style="margin: 25px auto;"><img src="<?php echo base_url();?>public/assets/images/go2gro_logo.png" alt="Go2Gro" style="width: 50%;"></div>
                    </a>
                </div>
                ...
                <div class="zipcode login_pform clearfix" id="zipcodevalset">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="tab">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-box">
                                            <input type="text" name="pin_code" class="input-text required-entry validate-password" id="pin_code" title="Zip code" placeholder="Zip code" oninput="this.className = ''" onkeyup="pincodesignup();">
                                            <span class="text-danger" id="zipcode_chek"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <input type="checkbox" id="terms" name="terms" class="checkbox" style="display: inline; width: 5%;position:relative;top: 4px;left: 14px;">
                                        <p class="inlineB" style="display: inline;margin-left: 15px;">By signing up, you agree to Go2Gro's 
                 ...
                 <div class="login_with">
                   ...
                   <!-- <h2 class="text-center fs-30 no-margin" ><a href="<?php //echo base_url();?>login"><span style="color:green;"> Log In Here</span></a></h2>-->
...
<script>
    ...
    function ajaxindicatorstart(text)
    {
        ...
        jQuery('body').append('<div id="resultLoading" style="display:none"><div><img src="<?php echo base_url('assets/images/ajax-loader.gif');?>"><div>'+text+'</div></div><div class="bg"></div></div>');
        }
