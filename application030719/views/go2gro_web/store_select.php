...
<section class="main-container col2-left-layout bounceInUp animated" style="margin-top:70px;">
            <div class="row mart87">
                <div class="col-md-12 text-center" style="border-bottom:solid 1px #d6d6d6">
                  <h1 class="store-head"> Stores Near You</h1>
                </div>
            </div>
			
			
 <div class="row res_mar_none" style="background: #fff;">
  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="man-section">
        <div class="container">
            <div class="row" style="margin: 0px 0px 25px 0px; text-align: center;">
                <div class="block-brands clearfix" style="padding: 10px;">
					       <?php /*
                    <div class="col-xs-12 col-lg-3 col-md-6 col-centered">
                        <a href="">
                            <div class="block-in text-center select-shadow">
                                <div class="block-into">
                                   <img src="https://www.go2gro.com/go2gro_beta//images/home_product/safeway.png" alt="" class="lazy img-responsive post-image">
                                </div>
                ...
                <?php } }else{
                    echo '<div class="text-center" style="font-size: 20px;">'.$stores['message'].'</div>';
                } ?>
...
<?php//'public/assets/js/home_js/script.js?'
