    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="">
                ...
                <h2 style="text-align:left; line-height:32px;">COLLECTION, USE AND DISCLOSURE OF PERSONALLY-IDENTIFYING INFORMATION</h2>
                ...
                <h2 style="text-align:left; line-height:32px;">BY REGISTERING WITH OR USING THE WEBSITE, YOU CONSENT TO THE USE AND DISCLOSURE OF YOUR PERSONALLY-IDENTIFYING INFORMATION AS DESCRIBED IN THIS "COLLECTION, USE AND DISCLOSURE OF PERSONALLY-IDENTIFYING INFORMATION" SECTION.</h2>
                ...
                <h2 style="text-align:left; font-style:italic; line-height:32px;">Changing Personally-Identifying Information; Account Termination </h2>
                ...
                <h2 style="text-align:left;  line-height:32px;">COLLECTION AND USE OF INFORMATION BY THIRD PARTIES GENERALLY</h2>
                ...
                <h2 style="text-align:left;  margin:15px 0;">PRIVACY POLICY CHANGES</h2>
                ...
                <h2 style="text-align:left; ">CALIFORNIA PRIVACY RIGHTS</h2>
                ...
                <h2 style="text-align:left; ">DO-NOT-TRACK POLICY</h2>
        ...
        <div>
            <div class="contentEditableContainer contentTextEditable">
                ...
                <div class="col-md-6">
                    ...
                    <h2 style="text-align:left; line-height:32px;"><b>OTHER NAMES</b></h2>
