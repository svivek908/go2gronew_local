...
<style>
  ...
  .nav-tabs > li.active > a{border: none;
    background: none repeat scroll 0 0 #e21837;
    color: #fff;
    margin: 15px;
    border-radius: 5px;
}
...
<button data-id="btn_'+catList.item_id+'" type="button" title="Add to Cart" class="button btn-cart btn-cartadd '+hiddenClassBtn+'" onClick="Addcartitemlist(\''+catList.item_id+'\','+catList.item_price+','+catList.Sales_tax+');"><span><i class="fas fa-shopping-cart"></i>Add to Cart</span></button>\
                  ...
                  <div class="social col-md-12 text-center">\
                        <ul class="link">\
                        <li class="fb"> <a href="https://www.facebook.com/go2gro/" rel="nofollow" target="_blank" style="text-decoration:none;background: #3d5997;"> </a> </li>\
                        <li class="linkedin"> <a href="http://www.linkedin.com/" rel="nofollow" target="_blank" style="text-decoration:none;background:#4875B4"> </a> </li>\
                        <li class="tw"> <a href="https://twitter.com/go2gro" rel="nofollow" target="_blank" style="text-decoration:none;background:#359BED;"> </a> </li>\
                        <li class="instagram"> <a href="https://www.instagram.com/go2gro/" rel="nofollow" target="_blank" style="text-decoration:none;border:none"> </a> </li>\
    ...
    <a type="button" href="<?php echo base_url();?>ShoppingCart"  title="Proceed to Checkout" class="button btn-proceed-checkout" style="margin-top:15px;"><span>Proceed to Checkout</span></a>\
              </li><br>\
              </ul>\
			     </div>\
                    </div>\
