            ...
            success: function (res) {
                ...
                if (res.error == true) {
                    ...
                    for (var i = 0; i < jsonLength; i++) {
                        ...
                        <td><img src="<?php echo base_url('public/upload/item/');?>'+ result.item_image + '" onerror="this.src=\'<?php echo base_url('public/upload/item/noprivew.jpg');?>\';" style="width:60px;height:60px;"/></td>\
...
//                        console.log(result.shipping_address);
        ...
        html1 += '<div class="col-md-4 pad10 borderRight">\
                <div class="row" >\
            <div class="col-md-12" style="margin:10px 0px;" id="order-detail"> <h4 class="mar5"> ORDER-DETAILS </h4></div>\
        </div>\
             <div class="row" >\
        ...
        <div class="row">\
         ...
         <div class="col-md-4 pad10 borderRight"  style="min-height: 220px;">\
            <div class="row">\
            <div class="col-md-12" style="margin:10px 0px;"> <h4 class="mar5"> ADDRESS </h4></div>\
        </div>\
        <div class="row">\
        ...
        <div class="col-md-8"> 	<p> ' + catList.ship_mobile + '</p></div>\
          ...
          <div class="col-md-4 pad10">\
            <div class="row">\
            <div class="col-md-12" style="margin:5px 0px;"> <h4 class="mar5"> INFO </h4></div>\
        </div>\
        <div class="row">\
            <div class="col-md-12">\
        ...
        if (catList.status == 0) {
            ...
            htmlslider += '<img src="<?php echo base_url('public/assets/images/111.png');?>" style=""><p>';

        }
        else if (catList.status == 1) {
            htmlslider += '<img src="<?php echo base_url('public/assets/images/222.png');?>" style=""><p>';
        }
        else if (catList.status == 2) {

            htmlslider += '<img src="<?php echo base_url('public/assets/images/333.png');?>" style=""><p>';

        }
        else if (catList.status == 3) {

            htmlslider += '<img src="<?php echo base_url('public/assets/images/444.png');?>" style=""><p>';

        }
        else if (catList.status == 4) {

            htmlslider += '<img src="<?php echo base_url('public/assets/images/555.png');?>" style=""><p>';
        }
        else if (catList.status == 5) {

            htmlslider += '<img src="<?php echo base_url('public/assets/images/rejected.png');?>" style=""><p>';

        }
        else if (catList.status == 6) {

            htmlslider += '<img src="<?php echo base_url();?>images/cancelled.png" style=""><p>';
