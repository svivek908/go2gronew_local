...
load_css(array('public/assets/stylesheet/profile.css?'));
?>
        ...
        <div class="row">
            <section class="col-main col-sm-12 wow bounceInUp animated animated cart-collaterals" style="visibility: visible;">
                        ...
                        <form id="updateprofile" method="post" action="javascript:void(0);">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <input type="text" name="address" class="form-control form_control_01 map_api_autocomplete" id="addressid" value="<?php echo $userresult['street_address'];?>">
                                    <input type="hidden" name="" id="latitude" value="<?php echo $userresult['latitude'];?>">
                                    <input type="hidden" name="" id="longitude" value="<?php echo $userresult['longitude'];?>">
                                </div>
                                <div class="form-group col-sm-12">
                                    <label>Unit</label>
                                    <input type="text" name="" class="form-control form_control_01" id="apt_no" value=" <?php echo $userresult['apt_no'];?>">
                                </div>
                                <div class="form-group col-sm-12">
                                    <label>Residential community</label>
                                    <input type="text" name="" class="form-control form_control_01" id="complex_name" value="<?php echo $userresult['complex_name'];?>">
                                </div>

								<!-- <div class="form-group col-sm-6">
									<label>Country</label>
									<select class="form-control form_control_01" name="country" id="countryid"  style="padding: 0px 5px !important;">
										<option value="<?php echo $country_id;?>"> <?php echo $county_name;?></option>
								 ...
								 <div class="form-group col-sm-6">
									...
									<select class="form-control form_control_01" name="state" id="stateid" style="padding: 0px 5px !important;">
                                        <?php foreach($states as $state){ ?>
										<option value="<?php echo $state['id'];?>" <?php if($state['id'] == $userresult['state_id']){ echo "seleted"; }?>><?php echo $state['name'];?></option>
                                        <?php } ?>
									</select>
								</div>
								<div class="form-group col-sm-6">
									<label>City*</label>
									<select  class="form-control form_control_01" name="city" id="cityid" style="padding: 0px 5px !important;">
										<?php foreach($cities as $city){ ?>
                                        <option value="<?php echo $city['id'];?>" <?php if($city['id'] == $userresult['city_id']){ echo "seleted"; }?>><?php echo $city['name'];?></option>
                                        <?php } ?>
									</select>
								</div>
								<div class="form-group col-sm-6">
                ...
                <div class="totals" style="margin-bottom:15px; ">
                    <div>
                        <h3>Credit Card Detail  <button type="button" class="pull-right btn btn-primary creditbtn" data-toggle="modal" data-target="#creditcard" onclick="resetFormProfile();" style="width:180px;margin-top: -10px;font-size: 12px;    background: #f00;">  Add Card</button></h3>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group marT15 clearfix">
                            <div class="col-sm-12 controls">
                                ...
                                <input type="text" name="zipcode" id="zipcode" placeholder="Zip Code" class="form-control zipcode-container" style="width:100px;display: inline-block; margin-right:5px;">
