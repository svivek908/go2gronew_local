                            ...
                            <div class="table-responsive">
                                <table class="data-table table-striped" id="my-orders-table">
                                    ...
                                    <tr class="first last">
                                        ...
                                        <th>Date</th>
                                        <th>Address</th>
                                        <th style="width: 169px;min-width: 160px;"><span class="nobr">Full Name</span></th>
                                        <th style="min-width: 140px;"><span class="nobr">Grand Total</span></th>
                                        <th>Status</th>
                                        <th>Action</th>
                                    </tr>
                                    </thead>
...
//                        console.log(result.shipping_address);
       ...
       <td><span class="nobr">'+time+'</span></td>\
        <td><span style="width: 200px;display:inline-block;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;" class="">'+shipping_address+'</span></td>\
