	...
	<div class="row">
		<div class="">
			<div class="col-sm-12 col-xs-12 col-lg-12">
				<div class="order-divman" style=" ">
					<div class="order-placedblock">
<!--						<input type="button"  onclick="orderplace();" value="ok" style="padding: 10px;"/>-->
						...
						<div class="table-responsive">
							<table class="data-table table-striped" id="my-orders-table">
								...
								<tr class="first last">
									...
									<th>Date</th>
									<th>Address</th>
									<th style="width: 148px;min-width: 138px;">Name</th>
									<th style="    min-width: 135px;"><span class="nobr">Grand Total</span></th>
									<th>Status</th>
									<th>Action</th>
								</tr>
								</thead>
