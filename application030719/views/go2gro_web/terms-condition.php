...
load_css(array('public/assets/stylesheet/pgstyle/terms-condition.css?'));
?>
    <div class="container top_space" style="">
        <div class="row">
            <div class="col-md-12">


                <h3 class="privacy-heading">TERMS OF USE GO2GRO
                </h3>
                <!--<p> <span>State of Georgia</span><span class="pull-right">Rev. 133A18A</span>-->
                </p>
                <p><span class="pull-right">Version Date: April 12, 2018</span>
                </p>
            </div>
            ...
            <div class="col-md-12">
                <div class="contentEditable">
                    ...
                    <p>This Terms of Use Agreement ("Agreement") constitutes a legally binding agreement made between you, whether personally or on behalf of an entity ("user" or "you") and SNPC GLOBAL LLC and its affiliated companies (collectively, "Company" or "we" or "us" or "our"), concerning your access to and use of the www.go2gro.com website as well as any other media form, media channel, mobile website or mobile application related or connected thereto (collectively, the "Website"). The Website provides the following service: Online Grocery Shopping and Delivery Service ("Company Services"). Supplemental terms and conditions or documents that may be posted on the Website from time to time, are hereby expressly incorporated into this Agreement by reference.</p>
            ...
            <div class="col-md-12">
                <div class="">
                    <h2><strong> PURCHASES; PAYMENT </strong></h2>
            ...
            <div class="col-md-12">
                ...
                <p style="font-style:italic;"> <strong>Regarding Your Registration</strong></p>
            ...
            <div class="col-md-12">
                <h2> <strong> GUIDELINES FOR REVIEWS </strong></h2>

                <p>Company may accept, reject or remove reviews in its sole discretion. Company has absolutely no obligation to screen reviews or to delete reviews, even if anyone considers reviews objectionable or inaccurate. Those persons posting reviews should comply with the following criteria: </p>
                <ul>
                    <li>
                        <p> reviewers should have firsthand experience with the person/entity being reviewed </p>
                    </li>
                    <li>
                        <p>reviews should not contain: offensive language, profanity, or abusive, racist, or hate language; discriminatory references based on religion, race, gender, national origin, age, marital status, sexual orientation or disability; or references to illegal activity</p>
                    </li>
                    <li>
                        <p> reviewers should not be affiliated with competitors if posting negative reviews</p>
                    </li>
                    <li>
                        <p> reviewers should not make any conclusions as to the legality of conduct and</p>

                    </li>
                    <li>
                        <p> reviewers may not post any false statements or organize a campaign encouraging others to post reviews, whether positive or negative. Reviews are not endorsed by Company, and do not represent the views of Company or of any affiliate or partner of Company. Company does not assume liability for any review or for any claims, liabilities or losses resulting from any review. By posting a review, the reviewer hereby grants to Company a perpetual, non-exclusive, worldwide, royalty-free, fully-paid, assignable and sublicensable license to Company to reproduce, modify, translate, transmit by any means, display, perform and/or distribute all content relating to reviews.</p>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-12">
                ...
                <p class="sub-heading"> Use License </p>
                ...
                <ul>
                    <li> <p> Decompile, reverse engineer, disassemble, attempt to derive the source code of, or decrypt the application</p> </li>
                    <li> <p> make any modification, adaptation, improvement, enhancement, translation or derivative work from the application</p> </li>
                    <li> <p> violate any applicable laws, rules or regulations in connection with your access or use of the application</p> </li>
                    <li> <p> remove, alter or obscure any proprietary notice (including any notice of copyright or trademark) of Company or its affiliates, partners, suppliers or the licensors of the application</p> </li>
                    <li> <p> use the application for any revenue generating endeavor, commercial enterprise, or other purpose for which it is not designed or intended</p> </li>
                    <li> <p> make the application available over a network or other environment permitting access or use by multiple devices or users at the same time</p> </li>
                    <li> <p> use the application for creating a product, service or software that is, directly or indirectly, competitive with or in any way a substitute for the application</p> </li>
                    <li> <p> use the application to send automated queries to any website or to send any unsolicited commercial e-mail</p> </li>
                    <li> <p> use any proprietary information or interfaces of Company or other intellectual property of Company in the design, development, manufacture, licensing or distribution of any applications, accessories or devices for use with the application.</p> </li>
                </ul>
            ...
            <div class="col-md-12">
                <p class="sub-heading"> Terms Applicable to Apple and Android Devices</p>
                <p>
                ...
                <ul>
                    <li> <p>  <span> SCOPE OF LICENSE:</span> The license granted to you for the Company application is limited to a non-transferable license to use the Company application on a device that utilizes the Apple iOS or Android operating system, as applicable, and in accordance with the usage rules set forth in the applicable App Distributor terms of service.</p> </li>

                    <li> <p>  <span> MAINTENANCE AND SUPPORT:</span> Company is solely responsible for providing any maintenance and support services with respect to the Company application, as specified in this Agreement, or as required under applicable law. You acknowledge that each App Distributor has no obligation whatsoever to furnish any maintenance and support services with respect to the Company application.</p> </li>

                    <li> <p>  <span>  WARRANTY:</span> Company is solely responsible for any product warranties, whether express or implied by law, to the extent not effectively disclaimed. In the event of any failure of the Company application to conform to any applicable warranty, you may notify an App Distributor, and the App Distributor, in accordance with its terms and policies, may refund the purchase price, if any, paid for the Company application, and to the maximum extent permitted by applicable law, an App Distributor will have no other warranty obligation whatsoever with respect to the Company application, and any other claims, losses, liabilities, damages, costs or expenses attributable to any failure to conform to any warranty will be Company's sole responsibility.</p> </li>

                    <li>
                        <p>
                            <span> PRODUCT CLAIMS :</span>
                            You acknowledge that Company, not an App Distributor, is responsible for addressing any claims of yours or any third party relating to the Company application or your possession and/or use of the Company application, including, but not limited to:
                        </p>
                        <ul class="sub-list">
                            <li> product liability claims</li>
                            <li> any claim that the Company application fails to conform to any applicable legal or regulatory requirement; and </li>
                            <li> claims arising under consumer protection or similar legislation. </li>
                            <li>  <span> INTELLECTUAL PROPERTY RIGHTS: </span> You acknowledge that, in the event of any third party claim that the Company application or your possession and use of the Company application infringes a third party's intellectual property rights, the App Distributor will not be responsible for the investigation, defense, settlement and discharge of any such intellectual property infringement claim. </li>
                        </ul>
                    </li>

                    <li>
                        <p>  <span>LEGAL COMPLIANCE:  </span>You represent and warrant that</p>
                        <ul class="sub-list">
                    ...
                    <li>
                        <p> <span> THIRD PARTY TERMS OF AGREEMENT:</span> You must comply with applicable third party terms of agreement when using the Company application, e.g., if you have a VoIP application, then you must not be in violation of their wireless data service agreement when using the Company application.</p>
                    </li>

                    <li>
                        <p>
                            <span>   THIRD PARTY BENEFICIARY:</span> Company and you acknowledge and agree that the App Distributors, and their subsidiaries, are third party beneficiaries of this Agreement, and that, upon your acceptance of the terms and conditions of this Agreement, each App Distributor will have the right (and will be deemed to have accepted the right) to enforce this Agreement against you as a third party beneficiary thereof.
                        </p>
                    </li>
            ...
            <div class="col-md-12">
                ...
                <ul>
                    <li> <p> attempting to bypass any measures of the Website designed to prevent or restrict access to the Website, or any portion of the Website</p> </li>
                    <li> <p> attempting to impersonate another user or person or using the username of another user</p></li>
                    <li> <p> criminal or tortious activity</p></li>
                    <li><p>deciphering, decompiling, disassembling or reverse engineering any of the software comprising or in any way making up a part of the Website</p></li>
                    <li><p>deleting the copyright or other proprietary rights notice from any Website content</p></li>
                    <li><p>engaging in any automated use of the system, such as using any data mining, robots or similar data gathering and extraction tools</p></li>
                    <li><p>except as may be the result of standard search engine or Internet browser usage, using or launching, developing or distributing any automated system, including, without limitation, any spider, robot (or "bot"), cheat utility, scraper or offline reader that accesses the Website, or using or launching any unauthorized script or other software</p></li>
                    <li><p>harassing, annoying, intimidating or threatening any Company employees or agents engaged in providing any portion of the Company Services to you</p></li>
                    <li><p>interfering with, disrupting, or creating an undue burden on the Website or the networks or services connected to the Website</p></li>
                    <li><p>making any unauthorized use of the Company Services, including collecting usernames and/or email addresses of users by electronic or other means for the purpose of sending unsolicited email, or creating user accounts by automated means or under false pretenses</p></li>
                    <li><p>selling or otherwise transferring your profile</p></li>
                    <li><p>systematic retrieval of data or other content from the Website to create or compile, directly or indirectly, a collection, compilation, database or directory without written permission from Company</p></li>
                    <li><p>tricking, defrauding or misleading Company and other users, especially in any attempt to learn sensitive account information such as passwords</p></li>
                    <li><p>using any information obtained from the Website in order to harass, abuse, or harm another person</p></li>
                    <li><p>using the Company Services as part of any effort to compete with Company or to provide services as a service bureau</p></li>
                    <li><p>using the Website in a manner inconsistent with any and all applicable laws and regulations</p></li>
                </ul>
            </div>
            <div class="col-md-12">
                ...
                <h2> <strong> THIRD PARTY WEBSITES AND CONTENT</strong></h2>
                ...
                <ul>
                    <li> <p> monitor the Website for violations of this Agreement;</p> </li>
                    <li> <p> take appropriate legal action against anyone who, in Company's sole discretion, violates this Agreement, including without limitation, reporting such user to law enforcement authorities;</p></li>
                    <li> <p> in Company's sole discretion and without limitation, refuse, restrict access to or availability of, or disable (to the extent technologically feasible) any user's contribution or any portion thereof that may violate this Agreement or any Company policy;</p></li>

                    <li><p>in Company's sole discretion and without limitation, notice or liability to remove from the Website or otherwise disable all files and content that are excessive in size or are in any way burdensome to Company's systems;</p></li>

                    <li><p>otherwise manage the Website in a manner designed to protect the rights and property of Company and others and to facilitate the proper functioning of the Website.</p></li>
                ...
                <h4 class="sub-heading ">To Agreement</h4>
                ...
                <h4 class="sub-heading "> Between Users</h4>
            ...
            <div class="col-md-12">
                ...
                <p>Product images, ingredients, nutrition facts and other packaging details, in some cases, may not be current or complete. We recommend our customers to always check the product's information physically before using or consuming. SNPC Global LLC aims to present absolutely correct and accurate product information but cannot ensure the accuracy of any product information presented on this website (www.go2gro.com). For absolute correct information, please refer to the manufacturer of the products.</p>
				
				<p> 	Disclaimer for Beer & Wine Customers: The Pennsylvania State Law restricts the purchase of alcoholic beverages more than 12 units so a customer cannot checkout more than two 6 packs or one 12 pack and Wine of up to 4 Bottles.</p>
				
				<p> Beers and Wine department is for 21+ customers only and Cigarette(Puffs) Department is for 18+ customers only. We do not encourage alcohol consumption as it is injurious to health. U.S. Government Issued ID or Passport will be checked upon arrival of order. If you do not have ID at time of delivery, or you fail to provide an authentic ID, you will be charged a NON-REFUNDABLE 50% restocking fee and will not receive any of the order. </p>
                ...
                <p>IN NO EVENT SHALL COMPANY OR ITS DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA OR OTHER DAMAGES ARISING FROM YOUR USE OF THE WEBSITE OR COMPANY SERVICES, EVEN IF COMPANY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, COMPANY'S LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO COMPANY FOR THE COMPANY SERVICES DURING THE PERIOD OF THREE (3) MONTH PRIOR TO ANY CAUSE OF ACTION ARISING.</p>
                ...
                <p>CUSTOMER OR PATRON EXHAUSTS HI/HER RIGHT TO FILE A LAWSUIT AGAINST THE  COMPANY OR ITS DIRECTORS, EMPLOYEES, OR AGENTS. </p>
                ...
                <p>SNPC GLOBAL LLC<br>
                    565 Cricklewood Drive<br>
                    State College PA 16803<br>
                    Email: customersupport@go2gro.com<br>
                    Phone: +1 (833) 346-2476 / +1 (833) 3GO-2GRO </p>
            </div>

            <div class="col-sm-6" style="margin-bottom: 30px;">
                <h2><strong>GENERAL INSTRUCTIONS</strong></h2>
                <h2>WHAT IS A TERMS OF USE AGREEMENT?</h2>
                ...
                <h2>WHEN IS A TERMS OF USE AGREEMENT NEEDED?</h2>
                ...
                <ul>
                    <li><p>how purchases, payment, and returns are handled</p></li>
                    <li><p>ownership and use of content and intellectual property</p></li>
                    <li><p>how Users must conduct themselves, including any prohibited behavior</p></li>
                    <li><p>limitations on liability and disclaimers</p></li>
                    <li><p>the Company's privacy policy</p></li>
                </ul>
                ...
                <ul>
                    <li><p><strong>E-Commerce Company - </strong>Ebay, Amazon, Target, Gap</p></li>
                    <li><p><strong>Social Media Website or Application - </strong>Facebook, Instagram, Twitter, Snapchat</p></li>
                    <li><p><strong>Search Engine - </strong>Google, Yahoo, Bing</p></li>
                    <li><p><strong>Website or Application Providing a Service or Product - </strong>YouTube, Apple, Uber</p></li>
                    <li><p><strong>Gaming Website or Application - </strong>Playstation, Pokemon Go, Candy Crush</p></li>
                </ul>
            </div>
            <div class="col-sm-6">
                <h2><strong>WHAT SHOULD BE INCLUDED IN A TEMS OF USE?</strong></h2>

                <p>A simple Terms of Service should generally have at least the following:</p>


                <ul>
                    <li><p>Who is the Company providing the service or product</p></li>
                    <li><p>What is the service or product provided by the Company</p></li>
                    <li><p>Where is the Company's website</p></li>
                    <li><p>When will the agreement terminate</p></li>
                    <li><p>Why might the User not be granted access to the website</p></li>

                    <li><p>How does the User agree to accept the Terms of Service</p></li>
                </ul>
                ...
                <ul>
                    <li><p>Terms of Service Agreement</p></li>
                    <li><p>Terms and Conditions</p></li>
                    <li><p>User Agreement</p></li>
                    <li><p>Statement of Rights and Responsibilities</p></li>
