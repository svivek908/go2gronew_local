...
$config['title'] = 'Go2Gro_Local';
$config['api_img_url']= $config['base_url'].'/public/';
$config['Web_unique_url']='1559907434';

$config['processing_fee']=0.79;
$config['deleviry_chargeold']=4.99;
$config['deleviry_charge']=3.99;
$config['free_deleviry_charge']=0.00;
$config['authorizeAmountpercent']=20;

//delivery time
$config['start'] = 9;
$config['end'] = 22;

// Authorize.net Account Info test
$config['authorize_env_url'] = "https://apitest.authorize.net";  //Sandbox
$config['api_login_id'] = '8Q6KHa7np76y';
$config['api_transaction_key'] = '2836Ha75kpLA5EDA';
$config['time_zone'] = "Asia/Kolkata";


// Authorize.net Account Info live
/*$config['authorize_env_url'] = "https://api2.authorize.net";   //production
$config['api_login_id'] = '9c5V9nmV5';
$config['api_transaction_key'] = '22cDxfs3yUA372u4';
$config['time_zone'] = "America/New_York";*/

$config['env']="test";  // for test
//$config['env']="production";  // for live

// test secrete key
$config['test_secret_key']="AW7a9QzQzpyfv1v_UkYFoF1KYBk6GU96ffEuV6GH_ZiCy4MEkU-JqvW-aZNbvDhExffjD-Lsd-yqQsSX";

// live secrete key
$config['live_secret_key']="ARlfgHxsfjP45W8pC_oGAocW0eBjGLF3AesEeTmWqEM_OaoHJyDC37xqIxwJZGnXjHXtqK7OEWs8hoWC";
...
|
*/
$config['encryption_key'] = 'cf546a661b3379f1081bb42a8ffa6c7a';
...
//define('alternataivelink','https://www.go2gro.com/go2gro_beta/alternate_product/');
...
// /*------------this certificate expire on dec-2019 pleace renew*/
// define("appleenv","appel_notification_test");
// define("apple_test_notificationpem",$_SERVER['DOCUMENT_ROOT'] . '/go2growApi/FCM/IosDevNoti.pem');

// //define("appleenv","appel_notification_live");
// //define("apple_notificationpem",$_SERVER['DOCUMENT_ROOT'] . '/go2gro_beta/go2growApi/FCM/LivePushNoti.pem');

define ("IOS_RESTRICT_CATEGORY", serialize (array (13)));

// define('IMAGE_SHOWURL','http://localhost/go2gronew_local');
// define('TIPS_ARR',
//     serialize(
//         [
