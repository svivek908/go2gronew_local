...
<link rel = "stylesheet" href = "public/forgotpassword/css/flexBackground.css"/>
	<script type = "<?php echo base_url();?>text/javascript" src = "public/forgotpassword/js/jquery.min.js"></script>	
	<script type = "<?php echo base_url();?>text/javascript" src="public/forgotpassword/js/flexBackground2.js"></script>
	...
	<div class = "flexBackground">
		<canvas class = "canvasBackground">
            ...
            <div id="bannerscollection_zoominout_opportune">
				...
				<div class="forget-passcontainer changepadss" id="bannerscollection_zoominout_photoText1111"> 
					<div class="logo"> 
						<img src="public/forgotpassword/images/logo_01.png" />
					</div>
					<div class="row wow bounceInleft" >
						<div class="col-md-4">
						<p class="heading">Your Password Changed Successfully <span class="fchange"> ! Thank You <span></p>
						<span class="redirect"> Redirect your website within 5 second</span>
					</div>
					</div>
				</div> 
           </div>  
